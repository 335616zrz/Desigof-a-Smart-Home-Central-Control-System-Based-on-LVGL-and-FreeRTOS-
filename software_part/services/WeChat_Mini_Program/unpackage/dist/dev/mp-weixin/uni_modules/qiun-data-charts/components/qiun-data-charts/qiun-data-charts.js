...
const _sfc_main = common_vendor.defineComponent({
  ...
  watch: {
    ...
    mixinDatacomErrorMessage(val = null, oldval = null) {
      if (val) {
        ...
        if (this.errorShow) {
          common_vendor.index.__f__("log", "at uni_modules/qiun-data-charts/components/qiun-data-charts/qiun-data-charts.vue:610", "[秋云图表组件]" + val);
        }
      }
    },
  ...
  methods: {
    ...
    checkData(anyData = null) {
      ...
      if (this.echarts === true) {
        ...
        if (this.type && uni_modules_qiunDataCharts_js_sdk_uCharts_configUcharts.cfu.type.includes(this.type)) {
          uni_modules_qiunDataCharts_js_sdk_uCharts_configUcharts.cfu.option[cid] = deepCloneAssign(new UTSJSONObject({}), uni_modules_qiunDataCharts_js_sdk_uCharts_configUcharts.cfu[this.type], this.opts);
    ...
    _clearChart() {
      let cid = this.cid;
      if (this.echrts !== true && uni_modules_qiunDataCharts_js_sdk_uCharts_configUcharts.cfu.option[cid] && uni_modules_qiunDataCharts_js_sdk_uCharts_configUcharts.cfu.option[cid].context) {
        ...
        if (data.width > 0 && data.height > 0) {
          ...
          if (this.inH5 || this.inApp) {
            if (this.echarts == true) {
              ...
              this.uchartsOpts = deepCloneAssign(new UTSJSONObject({}), uni_modules_qiunDataCharts_js_sdk_uCharts_configUcharts.cfu.option[cid]);
            }
          } else {
    ...
    _showTooltip(e = null) {
      ...
      if (tc && tc !== void 0 && tc !== null) {
        ...
        uni_modules_qiunDataCharts_js_sdk_uCharts_configUcharts.cfu.instance[cid].showToolTip(e, new UTSJSONObject({
          index: tc.index,
          offset,
      ...
      if (this.inScrollView === true || this.inAli) {
        common_vendor.index.createSelectorQuery().in(this).select("#ChartBoxId" + cid).boundingClientRect((data = null) => {
          ...
          if (move) {
            ...
            this.emitMsg(new UTSJSONObject({ name: "getIndex", params: new UTSJSONObject({ type: "getIndex", event: new UTSJSONObject({ x: e.detail.x - data.left, y: e.detail.y - data.top }), currentIndex, legendIndex, id: cid, opts: uni_modules_qiunDataCharts_js_sdk_uCharts_configUcharts.cfu.instance[cid].opts }) }));
          }
        }).exec();
      } else {
        if (move) {
          ...
          this.emitMsg(new UTSJSONObject({ name: "getIndex", params: new UTSJSONObject({ type: "getIndex", event: new UTSJSONObject({ x: e.detail.x, y: e.detail.y - e.currentTarget.offsetTop }), currentIndex, legendIndex, id: cid, opts: uni_modules_qiunDataCharts_js_sdk_uCharts_configUcharts.cfu.instance[cid].opts }) }));
        }
      }
    },
    _touchStart(e = null) {
