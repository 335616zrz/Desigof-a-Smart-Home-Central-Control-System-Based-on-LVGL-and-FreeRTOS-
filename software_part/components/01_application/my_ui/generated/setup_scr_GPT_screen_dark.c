...
{
    /* 深色 GPT 聊天页：进入时同样暂停/停止音乐播放，保证界面之间音频互斥 */
    ...
    lv_obj_set_style_bg_color(ui->screen_7_cont_1, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui->screen_7_chat_list, lv_color_hex(0x0c141c), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_7_chat_list, LV_GRAD_DIR_VER, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_color(ui->screen_7_chat_list, lv_color_hex(0x152c3a), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->screen_7_chat_list, 1, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->screen_7_chat_list, lv_color_hex(0x253244), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_border_color(ui->screen_7_chat_input_cont, lv_color_hex(0x253244), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui->screen_7_chat_input_cont, lv_color_hex(0x152c3a), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_7_chat_input_cont, LV_GRAD_DIR_VER, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_color(ui->screen_7_chat_input_cont, lv_color_hex(0x253244), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui->screen_7_mode_btn, lv_color_hex(0x253244), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->screen_7_mode_btn, 1, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->screen_7_mode_btn, lv_color_hex(0x3A4A5A), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui->screen_7_mode_btn_label, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui->screen_7_voice_btn, lv_color_hex(0x0c141c), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->screen_7_voice_btn, 1, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->screen_7_voice_btn, lv_color_hex(0x253244), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui->screen_7_voice_btn_label, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui->screen_7_input_ta, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    /* 键盘按键文字颜色保持黑色（与默认浅色键盘背景一致） */
    lv_obj_set_style_text_color(ui->screen_7_kb, lv_color_hex(0x000000), LV_PART_ITEMS | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui->screen_7_ime, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(cand, lv_color_hex(0x152c3a), 0);
    ...
    lv_obj_set_style_bg_color (cand, lv_color_hex(0x253244), LV_PART_ITEMS | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(cand, lv_color_hex(0xFFFFFF), LV_PART_ITEMS | LV_STATE_DEFAULT);
    /* 层级在键盘前即可，无需移到顶层 */
    ...
    //Init events for screen (dark GPT).
    events_init_screen_7_dark(ui);
}
/*
* Copyright 2025 NXP
* NXP Proprietary. This software is owned or controlled by NXP and may only be used strictly in
