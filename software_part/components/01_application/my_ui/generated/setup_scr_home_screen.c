...
void setup_scr_home_screen(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->screen_cont_1, 16, 224);
    lv_obj_set_size(ui->screen_cont_1, 291, 90);
    ...
    lv_obj_set_style_bg_opa(ui->screen_cont_1, 233, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_cont_1, lv_color_hex(0xccf2f6), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_cont_2, 315, 10);
    lv_obj_set_size(ui->screen_cont_2, 156, 302);
    ...
    lv_obj_set_style_bg_color(ui->screen_cont_2, lv_color_hex(0xccf2f6), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    /* 位置：如果想更居中，建议用 align 版本（见注释） */
    lv_obj_set_pos(ui->screen_label_1, 95, 30);
    /* 让宽度随内容变化，显示 00:00:00 也不会被截断 */
    lv_obj_set_size(ui->screen_label_1, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
    ...
    lv_obj_set_style_text_font(ui->screen_label_1, &lv_font_cn_num_30, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    /* 若更希望始终居中，可用这两行替换上面的 set_pos： */
    // lv_obj_align(ui->screen_label_1, LV_ALIGN_TOP_MID, 0, 18);
    ...
    /* 位置和大小（需要移动就改这两个数） */
    lv_obj_set_pos(ui->screen_label_2, 97, 69);
    lv_obj_set_size(ui->screen_label_2, 129, LV_SIZE_CONTENT);
    
    /* 初始占位文本，后面由 time_ui 实时刷新 */
    ...
    /* 关键：把这两个标签绑定给 time_ui，让它来刷新文本 */
    extern void time_ui_bind_labels(lv_obj_t *lbl_time, lv_obj_t *lbl_date);
    time_ui_bind_labels(ui->screen_label_1, ui->screen_label_2);

    //Write codes screen_label_3
    ui->screen_label_3 = lv_label_create(ui->screen);
    lv_obj_set_pos(ui->screen_label_3, 23, 108);
    lv_obj_set_size(ui->screen_label_3, 100, 32);
    lv_label_set_text(ui->screen_label_3, "你好未来");
    ...
    lv_obj_set_style_text_font(ui->screen_label_3, &lv_font_SourceHanSerifSC_Regular_25, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_label_4, 51, 144);
    lv_obj_set_size(ui->screen_label_4, 236, 30);
    lv_label_set_text(ui->screen_label_4, "肆意人生，万事顺心");
    ...
    lv_obj_set_style_text_font(ui->screen_label_4, &lv_font_SourceHanSerifSC_Regular_22, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_img_1, 69, 243);
    lv_obj_set_size(ui->screen_img_1, 49, 57);
    lv_obj_add_flag(ui->screen_img_1, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->screen_img_1, &_Thermometer_RGB565A8_49x57);
    ...
    lv_obj_set_pos(ui->screen_label_5, 110, 258);
    lv_obj_set_size(ui->screen_label_5, 43, 32);
    // 初始占位：由天气数据填充为温度数字（不带°）
    ...
    lv_obj_set_style_text_font(ui->screen_label_5, &lv_font_cn_num_30, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_label_6, 153, 258);
    lv_obj_set_size(ui->screen_label_6, 29, 26);
    ...
    lv_obj_set_style_text_font(ui->screen_label_6, &lv_font_cn_num_30, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_img_2, 11, 14);
    lv_obj_set_size(ui->screen_img_2, 80, 82);
    lv_obj_add_flag(ui->screen_img_2, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->screen_img_2, &_Robot_RGB565A8_80x82);
    ...
    lv_obj_set_pos(ui->screen_img_3, 192, 243);
    lv_obj_set_size(ui->screen_img_3, 49, 57);
    lv_obj_add_flag(ui->screen_img_3, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->screen_img_3, &_Hygrometer_RGB565A8_49x57);
    ...
    lv_obj_set_pos(ui->screen_label_9, 231, 258);
    lv_obj_set_size(ui->screen_label_9, 43, 32);
    // 初始占位：由天气数据填充为湿度数字（不带%）
    ...
    lv_obj_set_style_text_font(ui->screen_label_9, &lv_font_cn_num_30, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_label_10, 273, 258);
    lv_obj_set_size(ui->screen_label_10, 29, 26);
    ...
    lv_obj_set_style_text_font(ui->screen_label_10, &lv_font_cn_num_30, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_label_11, 23, 188);
    /* 单行显示 + 超长省略号，设定固定宽度以启用 DOT 效果 */
    lv_obj_set_size(ui->screen_label_11, 220, 26);
    // 初始占位：由天气数据填充为“省 市/区”
    lv_label_set_text(ui->screen_label_11, "—— ——");
    /* 禁止换行，超长以省略号显示 */
    lv_label_set_long_mode(ui->screen_label_11, LV_LABEL_LONG_DOT);
    ...
    lv_obj_set_style_text_font(ui->screen_label_11, &lv_font_montserratMedium_24, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_label_12, 32, 239);
    lv_obj_set_size(ui->screen_label_12, 44, 68);
    lv_label_set_text(ui->screen_label_12, "室\n外");
    lv_label_set_long_mode(ui->screen_label_12, LV_LABEL_LONG_WRAP);
    /* 允许点击以在“室内/室外”之间切换数据来源 */
    lv_obj_add_flag(ui->screen_label_12, LV_OBJ_FLAG_CLICKABLE);
    ...
    lv_obj_set_style_text_font(ui->screen_label_12, &lv_font_cn_num_30, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_label_13, 234, 45);
    lv_obj_set_size(ui->screen_label_13, LV_SIZE_CONTENT, LV_SIZE_CONTENT);

    /* 初始占位：由 time_ui 刷新为“星期X” */
    lv_label_set_text(ui->screen_label_13, "星期--");
    ...
    lv_obj_set_style_text_font(ui->screen_label_13, &lv_font_montserratMedium_24, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    time_ui_bind_week_label(ui->screen_label_13);

    //Write codes screen_label_14
    ui->screen_label_14 = lv_label_create(ui->screen);
    lv_obj_set_pos(ui->screen_label_14, 220, 188);
    lv_obj_set_size(ui->screen_label_14, 61, 23);
    ...
    lv_obj_set_style_text_font(ui->screen_label_14, &lv_font_montserratMedium_24, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_arc_1, 315, 3);
    lv_obj_set_size(ui->screen_arc_1, 165, 153);
    ...
    lv_obj_set_style_text_font(ui->screen_label_15, &lv_font_montserratMedium_24, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_sw_1, 354, 202);
    lv_obj_set_size(ui->screen_sw_1, 84, 37);
    ...
    lv_obj_set_pos(ui->screen_label_16, 344, 258);
    lv_obj_set_size(ui->screen_label_16, 100, 32);
    lv_label_set_text(ui->screen_label_16, "翻转");
    ...
    lv_obj_set_style_text_font(ui->screen_label_16, &lv_font_montserratMedium_24, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_img_4, 237, 10);
    lv_obj_set_size(ui->screen_img_4, 22, 26);
    lv_obj_add_flag(ui->screen_img_4, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->screen_img_4, &_wifi_RGB565A8_22x26);
    ...
    lv_obj_set_pos(ui->screen_img_5, 266, 6);
    lv_obj_set_size(ui->screen_img_5, 33, 33);
    lv_obj_add_flag(ui->screen_img_5, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->screen_img_5, &_battery_RGB565A8_33x33);
    ...
    /* ===================== OTA 升级入口 + 弹窗（圆角矩形，确认/取消，进度条） ===================== */
    lv_obj_t *screen_img_ota_update = lv_image_create(ui->screen);
    lv_obj_set_pos(screen_img_ota_update, 430, 270);
    lv_obj_set_size(screen_img_ota_update, 50, 50);
    lv_obj_add_flag(screen_img_ota_update, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(screen_img_ota_update, &_version_update_RGB565A8_50x50);
    lv_image_set_pivot(screen_img_ota_update, 50, 50);
    lv_image_set_rotation(screen_img_ota_update, 0);
    lv_obj_set_style_image_recolor_opa(screen_img_ota_update, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_image_opa(screen_img_ota_update, 255, LV_PART_MAIN|LV_STATE_DEFAULT);

    ota_upgrade_dialog_create(ui->screen, false);
    ota_upgrade_dialog_bind_open_button(screen_img_ota_update, false);
    ...
    time_ui_init();
    time_ui_attach(guider_ui.screen_label_1, guider_ui.screen_label_2);
