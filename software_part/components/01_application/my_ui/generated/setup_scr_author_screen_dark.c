...
void setup_scr_author_screen_dark(lv_ui *ui)
{
    ...
    lv_label_set_text(ui->screen_6_label_1, "吕梁学院 物理与电子信息工程系");
    ...
    lv_label_set_text(ui->screen_6_label_4, "电子信息工程 2204班");
    ...
    lv_label_set_text(ui->screen_6_label_5, "张瑞钊");
    ...
    lv_label_set_text(ui->screen_6_label_6, "指导老师：张辰锐");
    ...
    lv_obj_set_pos(ui->screen_6_label_7, 30, 270);
    lv_obj_set_size(ui->screen_6_label_7, 430, 30);
    lv_label_set_text(ui->screen_6_label_7, "个人开源：https://github.com/");
    ...
    lv_obj_set_style_text_font(ui->screen_6_label_7, &lv_font_SourceHanSerifSC_Regular_25, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_6_label_8, "开发库：Free RTOS+LVGL");
