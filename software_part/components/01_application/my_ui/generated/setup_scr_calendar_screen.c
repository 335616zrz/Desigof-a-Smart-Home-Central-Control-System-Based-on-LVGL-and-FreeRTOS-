...
static void calendar_update_month_view(lv_ui *ui)
{
    ...
    for (int i = 0; i < 42; ++i) {
        ...
        lv_obj_set_style_bg_color(cell->btn, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
        ...
        lv_color_t txt_color = lv_color_hex(0x000000);
        if (cell->other_month) {
            txt_color = lv_color_hex(0xcccccc);
        }
...
void setup_scr_calendar_screen(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_color(ui->calendar_main, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui->calendar_header_cont, lv_color_hex(0xE6F0FF), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    */
    ...
    lv_obj_set_style_text_color(ui->calendar_title, lv_color_hex(0x0D3055), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui->calendar_today_label, lv_color_hex(0x0D3055), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(jump_panel, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(jump_title, lv_color_hex(0x0D3055), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(s_calendar_jump_tip_label, lv_color_hex(0x5b7997), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    /* 初始滚轮值：使用当前月/选中日（内部会构建月份与日期滚轮文本） */
    ...
    /* 浅蓝色背景，区分为“跳转到该月” */
    lv_obj_set_style_bg_color(s_calendar_jump_btn_month, lv_color_hex(0xD9F0FF), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(lbl_month, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(s_calendar_jump_btn_cancel, lv_color_hex(0xeeeeee), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(lbl_cancel, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_border_color(ui->calendar_month_view_cont, lv_color_hex(0xE0E0E0), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    for (int i = 0; i < 7; ++i) {
        ...
        lv_obj_set_style_text_color(lbl, lv_color_hex(0x333333), LV_PART_MAIN | LV_STATE_DEFAULT);
    }
    ...
    /* 更新布局并初始化本屏事件（主要是返回切换动画） */
    lv_obj_update_layout(ui->calendar_main);
    events_init_calendar_main(ui);
}
