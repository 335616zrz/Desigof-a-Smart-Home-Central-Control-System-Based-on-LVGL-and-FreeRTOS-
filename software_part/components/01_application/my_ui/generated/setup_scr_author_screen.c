...
void setup_scr_author_screen(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->screen_5_cont_1, 480, 320);
    ...
    ui->screen_5_img_1 = lv_image_create(ui->screen_5);
    lv_obj_set_pos(ui->screen_5_img_1, 0, 2);
    lv_obj_set_size(ui->screen_5_img_1, 30, 30);
    lv_obj_add_flag(ui->screen_5_img_1, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->screen_5_img_1, &_return_RGB565A8_30x30);
    lv_image_set_pivot(ui->screen_5_img_1, 50,50);
    lv_image_set_rotation(ui->screen_5_img_1, 0);

    //Write style for screen_5_img_1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_image_recolor_opa(ui->screen_5_img_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_image_opa(ui->screen_5_img_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_5_btn_1
    ui->screen_5_btn_1 = lv_button_create(ui->screen_5);
    lv_obj_set_pos(ui->screen_5_btn_1, 2, 2);
    lv_obj_set_size(ui->screen_5_btn_1, 30, 30);
    ui->screen_5_btn_1_label = lv_label_create(ui->screen_5_btn_1);
    lv_label_set_text(ui->screen_5_btn_1_label, "");
    ...
    lv_obj_set_style_border_width(ui->screen_5_btn_1, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui->screen_5_btn_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->screen_5_btn_1, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui->screen_5_btn_1, LV_BORDER_SIDE_FULL, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_5_btn_1, 10, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_5_label_2, 40, 180);
    lv_obj_set_size(ui->screen_5_label_2, 430, 30);
    lv_label_set_text(ui->screen_5_label_2, "开发平台：Linux+ESP-IDF");
    ...
    lv_obj_set_style_text_font(ui->screen_5_label_2, &lv_font_SourceHanSerifSC_Regular_25, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_5_label_3, 40, 60);
    lv_obj_set_size(ui->screen_5_label_3, 430, 30);
    lv_label_set_text(ui->screen_5_label_3, "2026 本科毕业设计");
    ...
    lv_obj_set_style_text_font(ui->screen_5_label_3, &lv_font_SourceHanSerifSC_Regular_25, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_5_label_4, &lv_font_SourceHanSerifSC_Regular_25, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_5_label_5, &lv_font_SourceHanSerifSC_Regular_25, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_5_label_6, &lv_font_SourceHanSerifSC_Regular_25, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_5_label_8, &lv_font_SourceHanSerifSC_Regular_25, LV_PART_MAIN|LV_STATE_DEFAULT);
